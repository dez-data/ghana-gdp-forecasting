...
```{r}
setwd("C:/Users/SamuelAster Agondeze/Documents")
...
ggplot(gdp_d.f, aes(x = Year, y = GDP)) +
  ...
  labs(title = "Ghana GDP Time Series (1960–2023)",
       x = "Year",
       y = "GDP (in Millions)") +
  theme_minimal()
```
...
**Differencing**\
Here, we are determining how many times the series should be differenced to achieve stationarity
...
It Suggests ARIMA(1,2,3), excellent correspondence with the differencing order(**I**) of " that we determined earlier.
